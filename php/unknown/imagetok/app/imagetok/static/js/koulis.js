...
(() => {
    const gif = `${window.location.origin}/assets/koulis.gif`;
    ...
    image.addEventListener('load', () => {
        ...
        ctx.strokeText('Welcome to the imagebin of nightmares', 110, 180);
        ctx.fillText('Welcome to the imagebin of nightmares', 110, 180);

        ctx.strokeText('Makelarides are watching you 🔫', 133, 210);
        ctx.fillText('Makelarides are watching you 🔫', 133, 210);
